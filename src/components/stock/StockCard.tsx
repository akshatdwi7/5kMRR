...
export const StockCard: React.FC<StockCardProps> = ({ stock }) => {
  ...
  return (
    ...
    >
      <Card 
        className="cursor-pointer bg-gradient-to-br from-white to-gray-50 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300"
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <div className="text-sm font-semibold text-gray-900">{stock.pe.toFixed(1)}</div>
          </div>
        </div>
